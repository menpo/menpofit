...
class UnifiedAAMCLMAlgorithmResult(ParametricIterativeResult):
    r"""
    Class for storing the iterative result of a Unified AAM-CLM optimisation
    algorithm.
    ...
    def __init__(self, shapes, shape_parameters, appearance_parameters,
        ...
        super(UnifiedAAMCLMAlgorithmResult, self).__init__(
...
class UnifiedAAMCLMResult(MultiScaleParametricIterativeResult):
    r"""
    Class for storing the multi-scale iterative fitting result of a Unified
    AAM-CLM. It holds the shapes, shape parameters, appearance parameters and
    costs per iteration.
    ...
    def __init__(self, results, scales, affine_transforms, scale_transforms,
        ...
        super(UnifiedAAMCLMResult, self).__init__(
